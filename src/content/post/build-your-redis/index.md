...
description: "这是一个 codecrafter 课程练习，使用 Java 语言模拟 Redis 服务的各种功能。"
publishDate: "2026-05-05 13:00+0800"
coverImage:
  src: "./cover.png"
  alt: "here's the cover"
tags: ["java", "redis", "practice"]
draft: false
---
### 前言
　　这是一个 codecrafters 课程练习，使用 Java 语言模拟 Redis 服务的各种功能。简要记录下内容、实现、思考。
...
```
### 如何读取客户端的发送数据呢？
　　通过客户端 socket 对象，获取输入流（此处主体是服务器，输入流即发向服务器的数据）；回复客户端则使用 socket 的输出流。
```java
